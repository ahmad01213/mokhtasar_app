                            ...
                            <tr role="row" class="odd" align="center">
                                <td align="center" tabindex="0" class="sorting_1"
                                    ...
                                    <div class="container" style=" display: flex;justify-content:center;">
                                        ...
                                        <form action="{{ route('products.destroy' , ['product' => $row->id]) }}"
                                              method="post">
                                            {{ csrf_field() }}
                                            {{ method_field('delete') }}
                                        ...
                                        {{--                                        <a class="btn btn-danger order-delete" href="{{ route('products.destroy', ['user'=>$row->id]) }}" id="2" style="margin-right: 10px; height: 30px;font-size: 12px; ">--}}
                                        {{--                                            حذف--}}
                                        {{--                                        </a>--}}
                                        <a class="btn btn-primary order-delete"
                                           href="{{ route('products.edit', ['product'=>$row->id]) }}" id="2"
                                           style="margin-right: 10px; height: 30px;font-size: 12px; ">
                                            تعديل
                                        </a>
                                    </div>
