...
<div class="row row1 margin: 0 auto;" style="text-align: center;">
  <div class="col-lg-3 col-6">
    ...
    <div class="small-box bg-info">
      ...
      <a href="{{ route('sellerorders.index')}}" class="small-box-footer">المزيد <i class="fas fa-arrow-circle-right"></i></a>
    </div>
  </div>
  <!-- ./col -->
  <div class="col-lg-3 col-6">
    ...
    <div class="small-box bg-success">
      ...
      <a href="{{ route('sellerproducts.index')}}" class="small-box-footer">المزيد <i class="fas fa-arrow-circle-right"></i></a>
    </div>
  </div>
  <!-- ./col -->
  <!-- ./col -->
            ...
            <tr role="row" class="odd" align="center">
              <td align="center" tabindex="0" class="sorting_1" style="text-align: center;width: 200px;">
                ...
                <div class="container" style=" display: flex;justify-content:center;">
                  <a class="btn btn-primary order-delete" href="{{ route('sellerorders.edit', ['order'=>$row->id]) }}" id="2" style="margin-right: 10px; height: 30px;font-size: 12px; ">
                    المنتجات
                  </a>
                </div>
